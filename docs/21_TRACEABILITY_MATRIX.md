...
| Control-plane Load Profile | CI / API | ADR-0008 | AF-511 | Pinned 100-user Locust workflow emits CSV/HTML percentile evidence; achieved numbers remain pending the PR workflow run |
