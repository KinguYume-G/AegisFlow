...
- The repository is in **M1 implementation**; AF-101 through AF-107 and CI-001 are verified. AF-108 is the only active implementation Issue. / 仓库处于 **M1 实施阶段**；AF-101 至 AF-107 与 CI-001 均已验证，AF-108 是当前唯一实施中的 Issue。
...
- GitHub import and M0 verification are complete. AF-101 through AF-107 and CI-001 are verified; the AF-104–AF-110 Design Bundle v4 was human-merged in PR #84. / GitHub 导入与 M0 验证已完成；AF-101 至 AF-107 与 CI-001 已验证；AF-104–AF-110 Design Bundle v4 已通过 PR #84 人工合并。
...
Phase 0, AF-101 through AF-107, CI-001, and the M1 Design Bundle review are complete. The project is now implementing **AF-108**. / Phase 0、AF-101 至 AF-107、CI-001 与 M1 Design Bundle 审查均已完成；项目当前正在实施 **AF-108**。

Current work / 当前工作：

- Implement only the approved AF-108 in-memory clarification HITL contract and its run-isolation gates / 仅实施已批准的 AF-108 进程内 Clarification HITL 契约及其 run 隔离门禁；
- Do not start AF-109 until AF-108 is Human Merged and verified / AF-108 完成人工合并与验证前不得启动 AF-109；
- Continue One Issue → One Branch → One PR → Human Review/Merge / 继续严格执行单 Issue、单分支、单 PR 与人工审查合并。

Only AF-108 implementation is currently authorized; AF-109–AF-110 remain gated. / 当前仅授权实施 AF-108；AF-109–AF-110 仍受门禁约束。
